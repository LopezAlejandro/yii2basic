...
$items = [
    [
        ...
        [
        'label' => '<i class="glyphicon glyphicon-book"></i> '. Html::encode(Yii::t('app', 'Lectores Has Multas')),
        'content' => $this->render('_dataLectoresHasMultas', [
            'model' => $model,
            'row' => $model->lectoresHasMultas,
        ]),
    ],
                [
